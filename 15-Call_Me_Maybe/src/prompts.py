...
def build_prompt(
    ...
    return f"""
You are a helpful assistant that converts natural language to function call JSON.
...
- If no available function is relevant to the user query, use the function name "fn_is_not".
"""
